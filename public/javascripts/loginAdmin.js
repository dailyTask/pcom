...
angular.module("App")
    ...
    .controller("loginCtrl", function ($scope , $firebaseArray,$firebaseObject,$q) {
        var refAdd = new Firebase("https://dua-app.firebaseio.com/add")
        ...
        var refDoing = new Firebase("https://dua-app.firebaseio.com/diong")
        ...
        var refReview = new Firebase("https://dua-app.firebaseio.com/review")
            ...
            refReview.on("value", function (snapshot) {
             ...
             var refDone = new Firebase("https://dua-app.firebaseio.com/done")
